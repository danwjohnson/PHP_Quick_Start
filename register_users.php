...
/* This script registers a user by storing their information in a text file and creating
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {		// handle the form
	...
	}  // end of if to check if user name was entered on the form.
	...
	} // end of if to check if password was entered on the form.
	...
	} // end of if to check if password equals confirmed password
	...
	if (!$problem) {	// If there weren't any problems
		...
		}	// end of if/else to check for problems and then write the data if there weren't any.
		
	} else {	// Forgot a field.
		
		print '<p class="error">Please go back and try again</p>';
		
	}	// end of if/else to check for problems with entering data on the form	
...
<?php }		// End of submission if statement. ?>
